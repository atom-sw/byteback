...
import soot.baf.syntax.WordType;
...
public class Singletons {
    ...
    public TagManager soot_tagkit_TagManager() {
        if (instance_soot_tagkit_TagManager == null) {
            synchronized (this) {
                if (instance_soot_tagkit_TagManager == null)
                    instance_soot_tagkit_TagManager = new TagManager(g);
            }
        }
    ...
    public Baf soot_baf_Baf() {
        if (instance_soot_baf_Baf == null) {
            synchronized (this) {
                if (instance_soot_baf_Baf == null)
                    instance_soot_baf_Baf = new Baf(g);
            }
        }
    ...
    public ConstructorFolder soot_grimp_toolkits_base_ConstructorFolder() {
        if (instance_soot_grimp_toolkits_base_ConstructorFolder == null) {
            synchronized (this) {
                if (instance_soot_grimp_toolkits_base_ConstructorFolder == null)
                    instance_soot_grimp_toolkits_base_ConstructorFolder = new ConstructorFolder(g);
            }
        }
    ...
    public DoubleWordType soot_baf_DoubleWordType() {
        if (instance_soot_baf_DoubleWordType == null) {
            synchronized (this) {
                if (instance_soot_baf_DoubleWordType == null)
                    instance_soot_baf_DoubleWordType = new DoubleWordType(g);
            }
        }
    ...
    public LineNumberTagAggregator soot_tagkit_LineNumberTagAggregator() {
        if (instance_soot_tagkit_LineNumberTagAggregator == null) {
            synchronized (this) {
                if (instance_soot_tagkit_LineNumberTagAggregator == null)
                    instance_soot_tagkit_LineNumberTagAggregator = new LineNumberTagAggregator(g);
            }
        }
    ...
    public InnerClassTagAggregator soot_tagkit_InnerClassTagAggregator() {
        if (instance_soot_tagkit_InnerClassTagAggregator == null) {
            synchronized (this) {
                if (instance_soot_tagkit_InnerClassTagAggregator == null)
                    instance_soot_tagkit_InnerClassTagAggregator = new InnerClassTagAggregator(g);
            }
        }
    ...
    public WordType soot_baf_WordType() {
        if (instance_soot_baf_WordType == null) {
            synchronized (this) {
                if (instance_soot_baf_WordType == null)
                    instance_soot_baf_WordType = new WordType(g);
            }
        }

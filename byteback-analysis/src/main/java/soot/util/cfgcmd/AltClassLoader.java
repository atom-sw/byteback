...
public class AltClassLoader extends ClassLoader {
     ...
     *
     * @param altClassPath A list of directories and jar files to search for class files, delimited by {@link File#pathSeparator}.
     */
     ...
     *
     * @param classNames[] an array containing the names of classes to be loaded from the AltClassLoader.
     */
     ...
     * @throws IllegalArgumentException if <code>origName</code> is not amenable to our crude mangling.
     */
     ...
     * </p>
     *
     * @param maybeMangledName A string from which the desired class's name can be determined. It may have been mangled by
     ...
     *
     * @throws IllegalArgumentException if the lengths of <code>text</code> and <code>replacement</code> differ.
     */
     ...
     *
     * @throws ArrayIndexOutOfBounds if there are not <code>replacement.length</code> remaining after <code>text[start]</code>.
     */

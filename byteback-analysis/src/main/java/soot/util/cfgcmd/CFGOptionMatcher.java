...
public class CFGOptionMatcher {
     ...
     * @throws soot.CompilationDeathException if <code>quarry</code> matches none of the option names, or if it matches more than one.
     */
     ...
     *
     * @param initialIndent The number of blank spaces to insert at the beginning of the returned string. Ignored if negative.
     * @param rightMargin   If positive, newlines will be inserted to try to keep the length of each line in the returned string less than
     *                      or equal to <code>rightMargin</code>.
     * @param hangingIndent If positive, this number of spaces will be inserted immediately after each newline inserted to respect the

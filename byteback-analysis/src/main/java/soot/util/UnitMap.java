...
public abstract class UnitMap<T> implements Map<Unit, T> {
     ...
     *
     * @param b               a Body
     * @param initialCapacity the initialCapacity of the internal map.
     */
     ...
     * @param b               a Body
     * @param initialCapacity the initialCapacity of the internal map.
     * @param loadFactor      the loadFactor of the internal map.
     */
     ...
     * will be mapped.<br>
     *
     * @param unit Unit to which <code>o</code> should be mapped.

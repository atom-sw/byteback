...
import soot.tag.AnnotationEnumElement;
import soot.tag.AnnotationTag;
import soot.util.annotations.AnnotationElementSwitch.AnnotationElemResult;
...
public class AnnotationInstanceCreator {
     ...
     *
     *                          <li>a class defined within a {@link AnnotationElement} could not be loaded.</li>
     *
    ...
    public Object create(AnnotationTag tag) {
        ...
        try {
            ...
            for (AnnotationElement elem : tag.getElems()) {
            ...
            Object result = Proxy.newProxyInstance(cl, new Class[]{clazz}, new AbstractInvocationHandler() {
                ...
                protected Object handleInvocation(Object proxy, Method method, Object[] args) throws Throwable {
                    ...
                    if (result != null) {
                        ...
                        if (result instanceof Object[] oa) {

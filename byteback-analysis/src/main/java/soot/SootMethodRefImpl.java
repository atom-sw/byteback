...
public class SootMethodRefImpl implements SootMethodRef {
     ...
     * @throws IllegalArgumentException is thrown when {@code declaringClass}, or {@code name}, or {@code returnType} is null
     */
    public SootMethodRefImpl(ClassModel declaringClass, String name, List<Type> parameterTypes, Type returnType,
                             boolean isStatic) {
    ...
    protected SootMethod tryResolve(final StringBuilder trace) {
        ...
        if (Scene.v().allowsPhantomRefs() && Options.v().ignore_resolution_errors()) {
            ...
            ClassModel classToAddTo = declaringClass;
    ...
    private SootMethod resolve(final StringBuilder trace) {
        ...
        if (Options.v().allow_phantom_refs() || ClassModel.INVOKEDYNAMIC_DUMMY_CLASS_NAME.equals(declaringClass.getName())) {
    ...
    public boolean equals(Object obj) {
        ...
        } else return this.returnType.equals(other.returnType);
    }
}

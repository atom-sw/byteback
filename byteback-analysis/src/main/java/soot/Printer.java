...
public class Printer {
    ...
    public void printTo(ClassModel cl, PrintWriter out) {
     ...
     *
     * @param b   the Body instance to print.
    ...
    public void setCustomClassSignaturePrinter(Function<ClassModel, String> customPrinter) {
    ...
    private String printSignature(ClassModel classModel) {
        if (customClassSignaturePrinter != null) {
            return customClassSignaturePrinter.apply(classModel);
        } else {
            return Scene.v().quotedNameOf(classModel.getName());
        }
    }

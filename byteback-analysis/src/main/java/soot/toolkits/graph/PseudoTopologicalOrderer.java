...
public class PseudoTopologicalOrderer<N> implements Orderer<N> {
    ...
    private static class ReverseOrderBuilder<N> {
         ...
         *
         * @param reverse specify if we want reverse pseudo-topological ordering, or not.
     ...
     *
     * @param isReversed specify if we want reverse pseudo-topological ordering, or not.
     * @deprecated use {@link #newList(DirectedGraph, boolean))} instead
     */
    @Deprecated

...
public class ExceptionalBlockGraph extends BlockGraph implements ExceptionalGraph<Block> {
     ...
     *
     * @param unitGraph The <code>ExceptionalUnitGraph</code> whose <code>Unit</code>s are to be split into blocks.
     */
     ...
     * @throws IllegalStateException if one of the elements in <code>keys</code> does not appear in <code>keyToValue</code>
     */
     ...
     * @param unitToBlock a {@link Map} from the units which are block heads or tails to the blocks that they belong to.

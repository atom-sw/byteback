...
import soot.baf.syntax.AddInst;
import soot.baf.syntax.AndInst;
import soot.baf.syntax.ArrayLengthInst;
import soot.baf.syntax.ArrayReadInst;
import soot.baf.syntax.ArrayWriteInst;
import soot.baf.syntax.CmpInst;
import soot.baf.syntax.CmpgInst;
import soot.baf.syntax.CmplInst;
import soot.baf.syntax.DivInst;
import soot.baf.syntax.Dup1Inst;
import soot.baf.syntax.Dup1_x1Inst;
import soot.baf.syntax.Dup1_x2Inst;
import soot.baf.syntax.Dup2Inst;
import soot.baf.syntax.Dup2_x1Inst;
import soot.baf.syntax.Dup2_x2Inst;
import soot.baf.syntax.DynamicInvokeInst;
import soot.baf.syntax.EnterMonitorInst;
import soot.baf.syntax.ExitMonitorInst;
import soot.baf.syntax.FieldGetInst;
import soot.baf.syntax.FieldPutInst;
import soot.baf.syntax.GotoInst;
import soot.baf.syntax.IdentityInst;
import soot.baf.syntax.IfCmpEqInst;
import soot.baf.syntax.IfCmpGeInst;
import soot.baf.syntax.IfCmpGtInst;
import soot.baf.syntax.IfCmpLeInst;
import soot.baf.syntax.IfCmpLtInst;
import soot.baf.syntax.IfCmpNeInst;
import soot.baf.syntax.IfEqInst;
import soot.baf.syntax.IfGeInst;
import soot.baf.syntax.IfGtInst;
import soot.baf.syntax.IfLeInst;
import soot.baf.syntax.IfLtInst;
import soot.baf.syntax.IfNeInst;
import soot.baf.syntax.IfNonNullInst;
import soot.baf.syntax.IfNullInst;
import soot.baf.syntax.IncInst;
import soot.baf.syntax.InstSwitch;
import soot.baf.syntax.InstanceCastInst;
import soot.baf.syntax.InstanceOfInst;
import soot.baf.syntax.InterfaceInvokeInst;
import soot.baf.syntax.JSRInst;
import soot.baf.syntax.LoadInst;
import soot.baf.syntax.LookupSwitchInst;
import soot.baf.syntax.MulInst;
import soot.baf.syntax.NegInst;
import soot.baf.syntax.NewArrayInst;
import soot.baf.syntax.NewInst;
import soot.baf.syntax.NewMultiArrayInst;
import soot.baf.syntax.NopInst;
import soot.baf.syntax.OrInst;
import soot.baf.syntax.PopInst;
import soot.baf.syntax.PrimitiveCastInst;
import soot.baf.syntax.PushInst;
import soot.baf.syntax.RemInst;
import soot.baf.syntax.ReturnInst;
import soot.baf.syntax.ReturnVoidInst;
import soot.baf.syntax.ShlInst;
import soot.baf.syntax.ShrInst;
import soot.baf.syntax.SpecialInvokeInst;
import soot.baf.syntax.StaticGetInst;
import soot.baf.syntax.StaticInvokeInst;
import soot.baf.syntax.StaticPutInst;
import soot.baf.syntax.StoreInst;
import soot.baf.syntax.SubInst;
import soot.baf.syntax.SwapInst;
import soot.baf.syntax.TableSwitchInst;
import soot.baf.syntax.ThrowInst;
import soot.baf.syntax.UshrInst;
import soot.baf.syntax.VirtualInvokeInst;
import soot.baf.syntax.XorInst;

...
public class PolymorphicMethodRef extends SootMethodRefImpl {
     ...
     */
    public static boolean handlesClass(ClassModel declaringClass) {
     ...
     */
    public PolymorphicMethodRef(ClassModel declaringClass, String name, List<Type> parameterTypes, Type returnType,
                                boolean isStatic) {

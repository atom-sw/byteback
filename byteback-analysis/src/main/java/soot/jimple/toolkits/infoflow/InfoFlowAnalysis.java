...
public class InfoFlowAnalysis {
    ...
    Map<ClassModel, ClassInfoFlowAnalysis> classToClassInfoFlowAnalysis;
    ...
    public InfoFlowAnalysis(boolean includePrimitiveDataFlow, boolean includeInnerFields, boolean printDebug) {
        ...
        classToClassInfoFlowAnalysis = new HashMap<ClassModel, ClassInfoFlowAnalysis>();
    }
    ...
    private ClassInfoFlowAnalysis getClassInfoFlowAnalysis(ClassModel sc) {
    ...
    public static String getNodeLabel(Object o) {
         ...
         */
        if (node instanceof FieldRef fr) {

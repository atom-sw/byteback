        ...
        while (nodeIt.hasNext()) {
          ...
          Value source = null;
            ...
            if (node instanceof ParameterRef) {
                ...
                source = node; // StaticFieldRef
            } else if (ie instanceof InstanceInvokeExpr iie && node instanceof InstanceFieldRef) {
            ...
            while (sinksIt.hasNext()) {
                ...
                if (sink instanceof ParameterRef param) {
                  if (param.getIndex() == -1) {
                    ...
                    handleFlowsToValue(sink, source, fs);
                } else if (ie instanceof InstanceInvokeExpr iie && sink instanceof InstanceFieldRef) {
          ...
          Value lv = as.getLeftOp();
            ...
            } else if (rv instanceof ArrayRef ar) // data flows from the base's data structure
            {
              ...
              if (ifr.getBase() == thisLocal) // data flows from the field ref
                ...
                sources.add(rv);
                interestingFlow = !ignoreThisDataType(rv.getType());
            } else if (rv instanceof BinopExpr be) {

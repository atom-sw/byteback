...
public class UnconditionalBranchFolder extends BodyTransformer {
    ...
    private static class Transformer {
        ...
        public Result transform() {
            ...
            NextUnit:
            for (final Iterator<Unit> stmtIt = units.iterator(); stmtIt.hasNext(); ) {
                Unit stmt = stmtIt.next();
                if (stmt instanceof GotoStmt stmtAsGotoStmt) {
                ...
                } else if (stmt instanceof IfStmt stmtAsIfStmt) {
                    ...
                    if (stmtIt.hasNext()) {
                        ...
                        if (successor == ifTarget) {
                            ...
                            continue NextUnit;
                        } else if (successor instanceof GotoStmt succAsGoto) {
                ...
                } else if (stmt instanceof SwitchStmt stmtAsSwitchStmt) {

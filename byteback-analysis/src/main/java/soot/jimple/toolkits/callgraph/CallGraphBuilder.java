...
public class CallGraphBuilder {
     ...
     * Processes one item.
     *
     * @param momc the method or method context
    ...
    protected void processArrays(final MethodOrMethodContext momc) {
        ...
        if (argArrays != null) {
            for (final Local argArray : argArrays) {
                ...
                if (pts instanceof PointsToSetInternal ptsi) {
                    ptsi.forall(new P2SetVisitor() {
                        ...
                        public void visit(Node n) {
                            ...
                            if (newExpr instanceof NewArrayExpr nae) {
                                Value size = nae.getSize();
                                if (size instanceof IntConstant arrSize) {

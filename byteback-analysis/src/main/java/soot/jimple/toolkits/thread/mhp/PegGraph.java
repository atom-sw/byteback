...
// public class PegGraph extends SimplePegGraph
{
     ...
     * @param addExceptionEdges If true then the control flow edges associated with exceptions are added.
     ...
     * @param addExceptionEdges                                     If true then the control flow edges associated with exceptions are added.
     * @param dontAddEdgeFromStmtBeforeAreaOfProtectionToCatchBlock This was added for Dava. If true, edges are not added from statement before area of protection to catch. If
    ...
    public void testMonitor() {
        ...
        for (Iterator iter = maps.iterator(); iter.hasNext(); ) {
            ...
            if (list.size() > 0) {
                ...
                while (it.hasNext()) {
                    Object obj = it.next();
                    if (obj instanceof JPegStmt stmt) {
                        Tag tag1 = stmt.getTags().get(0);
                        System.out.println(tag1 + " " + stmt);
                    } else {
                        ...
                        while (listIt.hasNext()) {
                            ...
                            if (oo instanceof JPegStmt unit) {

    ...
    private void visit(Unit unit, UnitGraph graph, SootMethod sm, String threadName, boolean addBeginNode) {
        ...
        if (unit instanceof MonitorStmt) {
            ...
            if (value instanceof Local) {
                ...
                if (type instanceof RefType) {
                    ...
                    ClassModel sc = ((RefType) type).getSootClass();
        ...
        if (((Stmt) unit).containsInvokeExpr()) {
            ...
            if (method.getName().equals("start")) {
                ...
                List<ClassModel> superClasses = hierarchy.getSuperclassesOfIncluding(method.getDeclaringClass());
                Iterator<ClassModel> it = superClasses.iterator();
            ...
            if (name.equals("wait") && (paras.size() == 0 || (paras.size() == 1 && paras.get(0) instanceof LongType)
                ...
                if ((name.equals("start") || name.equals("run")) && find) {
                    ...
                    while (mayAliasIt.hasNext()) {
                        ...
                        ClassModel mayClassModel = refType.getSootClass();

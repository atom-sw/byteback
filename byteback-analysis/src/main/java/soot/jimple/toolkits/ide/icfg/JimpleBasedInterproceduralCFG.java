...
public class JimpleBasedInterproceduralCFG extends AbstractJimpleBasedICFG {
     ...
     *
     * @param includePhantomCallees True if phantom methods shall be returned as potential callees, otherwise false
     */
     ...
     * no outgoing edges
     *
     * @param fallbackToImmediateCallees True to return the immediate callee if the callgraph does not contain any edges for the respective call site,

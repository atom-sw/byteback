...
public class AnnotationGenerator {
     ...
     * @param elems a (possibly empty) sequence of AnnotationElem objects corresponding to the elements that should be contained in
     *              this annotation
     */
    public void annotate(Host h, Class<? extends Annotation> klass, AnnotationElement... elems) {
     ...
     *              this annotation
     */
    public void annotate(Host h, Class<? extends Annotation> klass, List<AnnotationElement> elems) {
     ...
     *                       this annotation
     */
    public void annotate(Host h, String annotationName, int visibility, List<AnnotationElement> elems) {

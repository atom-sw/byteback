...
public class TypeResolver {
     ...
     **/
    public TypeVariable typeVariable(ClassModel classModel) {
    ...
    private void split_new() {
        ...
        for (Stmt stmt : stmts) {
            if (stmt instanceof InvokeStmt invoke) {

              if (invoke.getInvokeExpr() instanceof SpecialInvokeExpr special) {

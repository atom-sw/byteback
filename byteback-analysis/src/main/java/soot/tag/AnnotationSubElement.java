 ...
 */
public class AnnotationSubElement extends AnnotationElement {

    private final AnnotationTag value;

    public AnnotationSubElement(AnnotationTag t, char kind, String name) {
        super(kind, name);
        this.value = t;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AnnotationSubElement other = (AnnotationSubElement) obj;
        if (this.value == null) {

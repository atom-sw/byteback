...
public class AnnotationTag implements Tag {
     ...
     * The annotations
     */
    private List<AnnotationElement> elems;
    ...
    public AnnotationTag(String type, Collection<AnnotationElement> elements) {
        this.type = type;

        if (elements == null || elements.isEmpty()) {
            this.elems = null;
        } else if (elements instanceof List<?>) {
            this.elems = (List<AnnotationElement>) elements;
        } else {
            this.elems = new ArrayList<AnnotationElement>(elements);
        }
    }
    ...
    public AnnotationTag(String type, int numElem) {
        this.type = type;
        this.elems = new ArrayList<AnnotationElement>(numElem);
    }
    ...
    public String toString() {
        if (elems != null) {
            ...
            for (AnnotationElement next : elems) {
                sb.append('\n').append(next);
            }
            sb.append('\n');
            return sb.toString();
     ...
     */
    public void addElem(AnnotationElement elem) {
        if (elems == null) {
            elems = new ArrayList<AnnotationElement>();
        }
        elems.add(elem);
    }
     ...
     */
    public void setElems(List<AnnotationElement> list) {
        this.elems = list;
    }
     ...
     */
    public Collection<AnnotationElement> getElems() {

...
public class ClassModel extends AbstractHost {
    ...
    protected Chain<ClassModel> interfaces;

    protected boolean isInScene;
    protected ClassModel superClass;
    protected ClassModel outerClass;
     ...
     */
    public Chain<ClassModel> getInterfaces() {
        checkLevel(HIERARCHY);
     ...
     */
    public void addInterface(ClassModel interfaceClass) {
     ...
     */
    public void removeInterface(ClassModel interfaceClass) {
        // NOTE: implementsInterface(String) calls checkLevel(HIERARCHY)
        if (!implementsInterface(interfaceClass.getName())) {
     ...
     * hasSuperclass())
     */
    public ClassModel getSuperclassUnsafe() {
        checkLevel(HIERARCHY);
        return superClass;
    }
    ...
    public ClassModel getOuterClass() {
        checkLevel(HIERARCHY);
        if (outerClass == null) {
     ...
     */
    public ClassModel getOuterClassUnsafe() {
        checkLevel(HIERARCHY);
        return outerClass;
    }

    public void setOuterClass(ClassModel c) {
        checkLevel(HIERARCHY);
        outerClass = c;
    }
    ...
    public void setApplicationClass() {
        ...
        Chain<ClassModel> c = Scene.v().getContainingChain(this);
        if (c != null) {
            c.remove(this);
        }

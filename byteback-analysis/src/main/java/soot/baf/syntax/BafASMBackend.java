...
public class BafASMBackend extends AbstractASMBackend {
     ...
     */
    public BafASMBackend(ClassModel sc, int javaVersion) {
     ...
     *
     * @param mv The method visitor for writing out the bytecode
     * @param u  The unit for which to write out the tags
     */
    ...
    protected void generateInstruction(final MethodVisitor mv, Inst inst) {
        inst.apply(new InstSwitch() {
            ...
            public void caseInterfaceInvokeInst(InterfaceInvokeInst i) {
                SootMethodRef m = i.getMethodRef();
                ClassModel declaration = m.declaringClass();
                boolean isInterface = declaration.isPhantom() || declaration.isInterface();
                /*

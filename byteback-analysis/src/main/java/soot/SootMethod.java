...
public class SootMethod extends AbstractHost implements ClassMember, MethodOrMethodContext, SootMethodInterface {
     ...
     */
    protected List<ClassModel> exceptions;
    ...
    public SootMethod(String name, List<Type> parameterTypes, Type returnType, int modifiers,
        ...
        if (thrownExceptions != null && !thrownExceptions.isEmpty()) {
            this.exceptions = new ArrayList<ClassModel>(thrownExceptions);
        }
    ...
    public synchronized void setName(String name) {
        ...
        ClassModel oldDeclaringClass = declaringClass;
        if (wasDeclared) {
     ...
     */
    public synchronized void setDeclaringClass(ClassModel declClass) {
    ...
    public Body getActiveBody() {
        ...
        synchronized (this) {
            ...
            if (declaringClass != null) {
                declaringClass.checkLevel(ClassModel.BODIES);
            }
     ...
     * get retrieve its active body. Please call {@link ClassModel#setApplicationClass()} on the relevant class.
     */
     ...
     * get retrieve its active body. Please call {@link ClassModel#setApplicationClass()} on the relevant class.
     *
     * @param consumer Consumer that takes in the body of the method. The consumer is only invoked if the current invocation
     ...
     */
    public void addExceptionIfAbsent(ClassModel e) {
     ...
     */
    public void addException(ClassModel e) {
        logger.trace("Adding exception {}", e);

        if (exceptions == null) {
            exceptions = new ArrayList<ClassModel>();
     ...
     */
    public void removeException(ClassModel e) {
     ...
     */
    public boolean throwsException(ClassModel e) {
        return exceptions != null && exceptions.contains(e);
    }

    public void setExceptions(List<ClassModel> exceptions) {
        this.exceptions = (exceptions == null || exceptions.isEmpty()) ? null : new ArrayList<ClassModel>(exceptions);
    }
    ...
    public List<ClassModel> getExceptionsUnsafe() {
        return exceptions;
    }
    ...
    public String getBytecodeSignature() {
      String buffer = '<' +
              ...
              ": " +
              getName() +
              AbstractJasminClass.jasminDescriptorOf(makeRef()) +
              '>';
    ...
    public static String getSignature(ClassModel cl, String name, List<Type> params, Type returnType) {
    ...
    public String getDeclaration() {
        ...
        // Print exceptions
        if (exceptions != null) {
            Iterator<ClassModel> exceptionIt = this.getExceptions().iterator();

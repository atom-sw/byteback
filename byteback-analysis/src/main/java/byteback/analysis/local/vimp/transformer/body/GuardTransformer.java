...
import byteback.analysis.local.common.syntax.unit.iterator.TrapCollectingIterator;
...
import byteback.analysis.local.vimp.tag.unit.ExceptionalTargetFlagger;
...
public class GuardTransformer extends BodyTransformer {
    ...
    public void transformBody(final Body body) {
        ...
        final var unitIterator = new TrapCollectingIterator(units.snapshotIterator(), body.getTraps());

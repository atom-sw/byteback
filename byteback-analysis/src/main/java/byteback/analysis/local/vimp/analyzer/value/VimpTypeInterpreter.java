...
import byteback.analysis.local.common.analyzer.value.TypeInterpreter;
import byteback.analysis.local.jimple.syntax.JimpleTypeInterpreter;
...
public class VimpTypeInterpreter implements TypeInterpreter<Value> {
    ...
    public Type typeOf(final Value value) {
        ...
        } else if (value instanceof BinopExpr binopExpr) {

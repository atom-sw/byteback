package byteback.analysis.local.common.syntax.unit.iterator;
...
public class TrapCollectingIterator implements Iterator<Unit> {
     ...
     * @param unitIterator The underlying unit iterator.
     * @param traps The traps that this iterator must be made aware of.
     */
    public TrapCollectingIterator(final Iterator<Unit> unitIterator, final Iterable<Trap> traps) {

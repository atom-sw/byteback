...
public class JimpleBody extends StmtBody {
    ...
    public Object clone(boolean noLocalsClone) {
        Body b = new JimpleBody(getMethodModel());
    ...
    public void insertIdentityStmts() {
        insertIdentityStmts(getMethodModel().getDeclaringClass());
    }
     ...
     */
    public void insertIdentityStmts(ClassModel declaringClass) {
        ...
        int i = 0;
        for (Type t : getMethodModel().getParameterTypes()) {

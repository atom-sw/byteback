...
public class ReturnStmt extends OpStmt {
    ...
    public ReturnStmt(final Value returnValue) {
        this(new ImmediateBox(returnValue));
    }

    protected ReturnStmt(final ValueBox returnValueBox) {
        super(returnValueBox);
    }

    @Override
    public String toString() {
        return "return " + opBox.getValue().toString();
    }

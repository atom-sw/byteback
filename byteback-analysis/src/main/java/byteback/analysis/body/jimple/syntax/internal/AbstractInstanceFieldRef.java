...
import byteback.analysis.body.jimple.syntax.InstanceFieldRef;
import byteback.analysis.body.jimple.syntax.RefSwitch;
...
public abstract class AbstractInstanceFieldRef implements InstanceFieldRef, ConvertToBaf {
    ...
    public boolean equivTo(Object o) {
        if (o instanceof AbstractInstanceFieldRef fr) {

...
public class AbstractTrap implements Trap, Serializable {
     ...
     */
    protected AbstractTrap(ClassModel exception, UnitBox beginUnitBox, UnitBox endUnitBox, UnitBox handlerUnitBox) {
    ...
    @Override
    public byteback.analysis.body.jimple.syntax.Unit getBeginUnit() {
        return beginUnitBox.getUnit();
    }

    @Override
    public byteback.analysis.body.jimple.syntax.Unit getEndUnit() {
        return endUnitBox.getUnit();
    }

    @Override
    public byteback.analysis.body.jimple.syntax.Unit getHandlerUnit() {
    ...
    @Override
    public void setBeginUnit(byteback.analysis.body.jimple.syntax.Unit beginUnit) {
        beginUnitBox.setUnit(beginUnit);
    }

    @Override
    public void setEndUnit(byteback.analysis.body.jimple.syntax.Unit endUnit) {

...
public class SimpleLocalGenerator extends LocalGenerator {
    ...
    public SimpleLocalGenerator(final Body body) {
    ...
    public Local generateLocal(final Type type) {
        ...
        {
            Chain<Local> locals = this.locals;
            long modCount = locals.getModificationCount();

            if (this.expectedModCount != modCount) {
                this.expectedModCount = modCount;
                this.names = localNames = new HashSet<>(locals.size());
                for (Local l : locals) {

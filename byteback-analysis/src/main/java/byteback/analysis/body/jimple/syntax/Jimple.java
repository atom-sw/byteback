...
import byteback.analysis.body.jimple.syntax.internal.*;
...
public class Jimple {
     ...
     */
    public Trap newTrap(ClassModel exception, Unit beginStmt, Unit endStmt, Unit handlerStmt) {
        return new JTrap(exception, beginStmt, endStmt, handlerStmt);
    }

    public Trap newTrap(ClassModel exception, UnitBox beginStmt, UnitBox endStmt, UnitBox handlerStmt) {
        return new JTrap(exception, beginStmt, endStmt, handlerStmt);
    }

...
/**
 * A Unit box whose contents can be changed in a way that is reflected in the
 * outer Body.
 *
 * @author paganma
 */
public class MutableUnitBox implements UnitBox {
	...
	/**
	 * Swaps the `unit` in the surrounding body and redirects jumps to the previous
	 * unit to the new `unit`.
	 *

...
class IntegerSelectionSort {
  ...
  @Behavior
  def bounded_index(a: Array[Int], i: Int): Boolean = {
    lte(0, i) & lt(i, a.length)
  }

  @Behavior
  def bounded_indices(a: Array[Int], i: Int, j: Int): Boolean = {
    bounded_index(a, i) & bounded_index(a, j)
  }

  @Behavior
  def bounded_index(a: Array[Int], i: Int, m: Int): Boolean = {
    bounded_index(a, m)
  }

  @Behavior
  def is_minimum(a: Array[Int], i: Int, j: Int, m: Int): Boolean = {
    val k = Bindings.integer()
    forall(k, implies(lte(i, k) & lt(k, j), gte(a(k), a(m))))
  }

  @Behavior
  def is_minimum(a: Array[Int], i: Int, m: Int): Boolean = {
    is_minimum(a, i, a.length, m)
  }

  @Behavior
  def sorted(a: Array[Int], i: Int, j: Int): Boolean = {
    val k = Bindings.integer()
  ...
  @Behavior
  def partitioned(a: Array[Int], i: Int): Boolean = {
    val k = Bindings.integer()
    val l = Bindings.integer()
  ...
  @Behavior
  def array_is_sorted(a: Array[Int]): Boolean = {
    sorted(a, 0, a.length)
  }
  ...
  @TwoState
  @Behavior
  def swapped_elements(a: Array[Int], i: Int, j: Int): Boolean = {
    equal(old(a(i)), a(j)) & equal(old(a(j)), a(i))
  }

  @TwoState
  @Behavior
  def elements_invariance(a: Array[Int], i: Int, j: Int): Boolean = {
    val k = Bindings.integer()

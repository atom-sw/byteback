/**
 * RUN: %{byteback} -cp %{jar} -c %{class} -c %{class}$ImmutableGuavaCollectionSpec -c %{class}$ImmutableGuavaListSpec -c %{ghost}CollectionSpec -c %{ghost}ListSpec -o %t.bpl
 */
...
public class ImmutableGuavaLists<T> {
	...
	public static class ImmutableGuavaCollectionSpec {

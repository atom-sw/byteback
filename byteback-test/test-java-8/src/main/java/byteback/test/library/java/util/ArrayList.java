/**
 * RUN: %{byteback} -cp %{jar} -c %{class} -c %{class}$SubList -c %{class}$Itr -c byteback.test.library.java.util.AbstractList -c byteback.test.library.java.util.AbstractCollection -o %t.bpl
 */
 ...
 * CHECK: Boogie program verifier finished with 103 verified, 0 errors
 */
